...
----
(molecule_ansible) marc@tumbleweed:~/scap-security-guide-0.1.50> pip3 install lxml ansible testinfra molecule podman python-vagrant ansible-lint flake8 molecule[lint] molecule[podman]
----
